...
//
// The voice model comes in as a parameter (`tts.model`) so the popup can switch
// Aura-2 voices per language — English "thalia", Spanish "celeste", etc.
//
 ...
 * @param {object} args.tts    resolved TTS config from getVoiceConfig().tts
 */
export function connectTTS({ token, tts, onAudio, onOpen, onClose, onError, onControl }) {
